...
public class AppAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        appHolder.name.setText("应用名:"+appInfo.getAppName());
        appHolder.pkgName.setText("包名:"+appInfo.getAppPkgName());
        appHolder.version.setText("版本名:"+appInfo.getVersion());
        //点击ico打开APP
    ...
    public static class AppHolder {
        ...
        public AppHolder(View view) {
            ...
            version = (TextView) view.findViewById(R.id.item_main_list_app_version);
        }
    }
